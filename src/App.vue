...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      ...
      <h2 class="text-2xl font-bold bg-white rounded-lg text-center">
      ...
      <div v-if="total > 0" class="my-5 space-y-3 bg-gray-50 p-5">
        ...
        <p class="text-xl text-gray-500 text-center font-bold">Mensuales: {{ formatearDinero(pagaMensual) }}</p>
      </div>

      <div v-else class="text-center mt-5">Añade una cantidad y un plazo a pagar</div>
